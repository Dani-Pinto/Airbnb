    ...
    <main class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            <?php
                ...
                // Script de consulta
                $sql = "SELECT id_apartamento, alias, precio_dia, camas FROM apartamento";
                        ...
                        echo "<div class='anuncio'>";
                            ...
                            echo "<div class='contenido-anuncio'>";
                                ...
                                echo "<ul class='iconos-caracteristicas'>" .
                                        ...
                                        "</li>" .
                                    "</ul>";
                                echo "<a class='boton boton-amarillo' href='./php/crudApartamento/view.php?id=" . $apartamento['id_apartamento'] . "'>Ver Propiedad</a>";
                            echo "</div>";
                        echo "</div>";
